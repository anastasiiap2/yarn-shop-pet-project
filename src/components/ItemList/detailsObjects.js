export const acrylic = {
    ...
    "description": "Can acrylic yarns be of good quality? Yes, especially as mixes." +
        ...
        " We have interesting mixes for you that combine these features in pleasant, quality and good-price yarns."
}
...
export const mohair = {
    ...
    "description": "How to get a light and thin knit, which warms like a thick sweater?" +
        ...
        " the thickness does not matter. See for yourself!"
}
...
export const cotton = {
    ...
    "description": "Cotton yarn is the number one choice for spring and summer - no wonder." +
        ...
        " We like it because it absorbs moisture and is durable. We have it for you in several thicknesses and" +
        " in blends with acrylic or merino wool."
}
...
export const polyester = {
    ...
    "description": "It's a waste of work to knit with poor yarns." +
        ...
        "It also adds smoothness and shine. It's great as a small addition to other wool, and the best as a fur effect." +
        " Fur, i.e. all kinds of yarn for amigurumi. A good choice for allergy sufferers"
}
export const alpaca = {
    "name": "Alpaca Yarns",
    ...
    "description": "What do you do when sheep's wool is too chewy? You reach for alpaca yarn!" +
        ...
        " in blends with silk, merino or Peruvian wool. Do you already know the version of Blow Yarn - " +
        "the lighter and more durable one? Be sure to check out Air and Sky from Drops"
}
export const silk = {
    "name": "Silk Yarns",
...
export const merino = {
    ...
    "description": "\n" +
        ...
        " We have it in thicknesses from 3mm to 5mm and in a spring blend with cotton. And ah! These colors!"
}
...
export const knittingNeedles = {
    ...
    "description": "Knitting needles - it's not just a tool. This is the basis of every piece of work." +
        ...
        " We provide thicknesses from 3mm to 12mm and lines in all lengths."
}
...
export const crochetHooks = {
    ...
    "description": "Need custom crochet? That's why we have such a large selection of crochet hooks for you." +
        ...
        " many sizes - to suit any project."
}
...
export const auxiliaryTools = {
    ...
    "description": "All accessories for knitting machines." +
        ...
        " In the offer you will recognize popular brands such as: Knitpro, Prym , Pony, Opry." +
